...
- Planning, repo cards, and status snapshots now also surface compact repomap status, explicit policy modes, active slice metadata, slice source labels, and top ranked files when local repo artifacts are available
